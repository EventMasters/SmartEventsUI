...
function Logo({classes})
{
    return (
        <div className={classNames(classes.root, "flex items-center")}>
            <img className="logo-icon" src="assets/images/logos/events-logo-small.png" alt="logo"/>
            <Typography className="text-16 ml-8 font-light logo-text">SMART EVENTS</Typography>
