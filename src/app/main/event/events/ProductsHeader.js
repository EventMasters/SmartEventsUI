        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                <FuseAnimate animation="transition.expandIn" delay={300}>
                    <Icon className="text-32 mr-0 sm:mr-12">event_seat</Icon>
                </FuseAnimate>
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Past Events</Typography>
                </FuseAnimate>
            </div>
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/smartevents/event/newevent" className="whitespace-no-wrap" variant="contained">
                    <span className="hidden sm:flex">Create New Event</span>
