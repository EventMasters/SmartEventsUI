...
class Register extends Component {
    ...
    componentDidUpdate(prevProps, prevState)
    {
        ...
        //alert(this.props.location.state.redirectUrl);
            ...
            <div className={classNames(classes.root, "flex flex-col flex-1 flex-no-shrink p-24 md:flex-row md:p-0")}>
                ...
                <div className="flex flex-col flex-no-grow items-center text-white p-16 text-center md:p-128 md:items-start md:flex-no-shrink md:flex-1 md:text-left">
                    ...
                    <FuseAnimate animation="transition.expandIn">
                        <img className="w-160 mb-32" src="assets/images/logos/events-logo.png" alt="logo"/>
                    </FuseAnimate>
                    ...
                    <FuseAnimate delay={400}>
                        <Typography variant="subtitle1" color="inherit" className="max-w-512 mt-16">
                            Plan.Team.Organize events effectively
                        </Typography>
                    </FuseAnimate>
                </div>
